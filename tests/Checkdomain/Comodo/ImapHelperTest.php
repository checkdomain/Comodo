...
class ImapHelperTest extends AbstractTest
{
    ...
    private $messages = [
        ...
        [
            ...
            'date'        => '2014-05-04 12:43:00',
            'plainText'   => 'Thank you for placing your order. Your details'
                . ' have been passed to Comodo, who will be validating your'
                . ' order. Your Order Number is 12456789.
                            PositiveSSL Certificate for
                            www.test.de. Please quote this Order Number in'
                . ' all correspondence. You have purchased:',
            'type'        => 'confirmation',
        ...
        [
            ...
            'plainText'   => 'Domain:- test.test.co.uk
                            ...
                            The Issuance email address for this certificate'
                . ' was cdrobotcomodo@checkdomain.de and the order number was'
                . '12456789',
            'type'        => '1_expiry',
        ...
        [
            ...
            'plainText'   => 'Thank you for your recent order.
                            ...
                            We have begun validating your information so that'
                . ' we can issue your order. The following is the account'
